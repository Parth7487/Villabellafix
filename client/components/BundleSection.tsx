      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 mb-12">
          ...
          <div className="md:col-span-5 space-y-6 md:space-y-8">
            {/* Card 1 */}
            <div className="group h-full min-h-[400px] bg-gradient-to-br from-stone-50 to-white border border-stone-200 hover:border-stone-900 transition duration-500 overflow-hidden relative">
            ...
            <div className="group h-full min-h-[400px] bg-gradient-to-br from-stone-50 to-white border border-stone-200 hover:border-stone-900 transition duration-500 overflow-hidden relative">
              ...
              <div className="relative z-10 h-full flex flex-col p-8 md:p-10">
                ...
                <div className="mt-auto">
                  ...
                  <button className="w-full px-6 py-3 bg-stone-900 hover:bg-stone-800 text-white text-sm font-light tracking-wider uppercase rounded-sm transition duration-300 mt-6">
                    Velg
                  </button>
                </div>
              </div>
          ...
          {/* Right Column - Featured Card (Popular) */}
          <div className="md:col-span-7 md:row-span-2">
            <div className="group h-full min-h-[824px] bg-gradient-to-br from-stone-900 to-stone-800 relative overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition duration-700">
              {/* Background Image */}
              ...
              <div className="relative z-10 h-full flex flex-col p-8 md:p-12">
                ...
                <div className="flex-1">
                  <div className="space-y-4 mb-12">
                    <h3 className="text-5xl md:text-6xl font-light text-white leading-tight">
                      {bundleOptions[1].title}
                    </h3>
                    <p className="text-base text-stone-200 font-light leading-relaxed max-w-lg">
                      {bundleOptions[1].description} – Vår mest populære valg for de som vil ha det hele.
                    </p>
                  </div>

                  {/* Features */}
                  <div className="space-y-4 mb-12 py-8 border-y border-stone-700/50">
                  ...
                  <div>
                    ...
                    {bundleOptions[1].savings && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-emerald-400 font-light tracking-wide">
            ...
            <div className="group h-full min-h-[400px] bg-gradient-to-br from-stone-50 to-white border border-stone-200 hover:border-stone-900 transition duration-500 overflow-hidden relative">
              ...
              <div className="relative z-10 h-full flex flex-col p-8 md:p-10">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 flex-1">
                  ...
                  {/* Pricing */}
                  <div className="md:text-right space-y-3 flex flex-col justify-between">
                    <div>
                      <div className="flex md:flex-col md:items-end md:gap-0 items-baseline gap-2 mb-3">
                        <span className="text-4xl md:text-5xl font-light text-stone-900">
                    ...
                    <button className="px-8 py-3 bg-stone-900 hover:bg-stone-800 text-white text-sm font-light tracking-wider uppercase rounded-sm transition duration-300">
                      Velg
                    </button>
                  </div>
                </div>
