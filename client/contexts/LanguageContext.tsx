...
const translations: Record<Language, Record<string, string>> = {
  NO: {
    ...
    "bundle.sectionTitle": "Velg ditt sett",
    "bundle.sectionHeading": "Smarte pakker for alle",
    "bundle.essentials": "ESSENTIALS",
    "bundle.essentialsTitle": "Putekasse",
    "bundle.essentialsDesc": "Eksklusiv putekasse i håndlagd stoff",
    "bundle.mostPopular": "MOST POPULAR",
    "bundle.completeSet": "Komplett sett",
    "bundle.completeSetDesc": "Putekasse + innerpute",
    "bundle.ultimateValue": "ULTIMATE VALUE",
    "bundle.threeSets": "Tre sett",
    "bundle.threeSetsDesc": "Maksimal sparing og stil",
    "bundle.popular": "Populær",
    "bundle.from": "Fra",
    "bundle.choose": "Velg",
    "bundle.freeShipping": "Gratis frakt",
    "bundle.thirtyDayReturn": "30 dager retur",
    "bundle.handmadeNorway": "Håndlagd i Norge",
  ...
  EN: {
    ...
    "bundle.sectionTitle": "Choose Your Set",
    "bundle.sectionHeading": "Smart Packages for Everyone",
    "bundle.essentials": "ESSENTIALS",
    "bundle.essentialsTitle": "Pillow Cover",
    "bundle.essentialsDesc": "Exclusive handmade fabric pillow cover",
    "bundle.mostPopular": "MOST POPULAR",
    "bundle.completeSet": "Complete Set",
    "bundle.completeSetDesc": "Pillow cover + inner pillow",
    "bundle.ultimateValue": "ULTIMATE VALUE",
    "bundle.threeSets": "Three Sets",
    "bundle.threeSetsDesc": "Maximum savings and style",
    "bundle.popular": "Popular",
    "bundle.from": "From",
    "bundle.choose": "Choose",
    "bundle.freeShipping": "Free Shipping",
    "bundle.thirtyDayReturn": "30 Day Returns",
    "bundle.handmadeNorway": "Handmade in Norway",
